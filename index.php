...
if(isset($_POST['add_product'])){
  ...
  $product_image_temp_name='images/' .$product_image;
  ...
  if($insert_query){
    move_uploaded_file($product_image_temp_name,$product_image_temp_name);
...
<body>
<!--separate the header,  file and iclude it here-->
