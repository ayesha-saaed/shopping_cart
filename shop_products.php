...
if(isset($_POST['add_to_cart'])){
    ...
    $select_cartt=mysqli_query($conn, "Select * from `cartt` where name='$products_name'");
    if(mysqli_num_rows($select_cartt)>0){
        $display_message= "Product already added to cart!";
    }else{
        //insert cart data in cartt table
     $insert_products=mysqli_query($conn, "insert into `cartt` (name,price,image,quantity) values
